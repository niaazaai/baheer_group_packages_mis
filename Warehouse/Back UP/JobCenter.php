...
{   
    $ListType="Finish Goods Check List"; 
...
<!--  style = "border-bottom:4px dotted black ;" -->
    <div class = "d-flex justify-content-between  " >
        ...
        <div>
            <div> <span class = "fs-bold fs-2  ps-2 " >Warehouse Job Center</span> </div>    
        ...
        <div class= "d-flex justify-content-end mt-3">
            ...
            <form action="" method = "post">
                <select class = "form-select" name="ListType" id="ListType" style = "border:3px solid green; " onchange = "this.form.submit();" >  
                    ...
                    <option value="Finish Goods Check List">Finish Goods Check List</option>
                    <option value="Goods Request Check List">Goods Request Check List</option>
                    <option value="RG Resale List">RG Resale List</option>
                    <option value="Accepts List">Accepts List</option>
      ...
      <div class="row">
        <?php
            ...
            if(isset($_REQUEST['ListType']))
            {
                ...
                if($ListType=='Accepts List')
                {   
                    $Col='col-lg-9 col-md-9 col-sm-12 col-xs-12 pt-4 my-1';
                ?> 
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <label class="fw-bold my-1" for="">Select Request Type </label>
                        <form action="" method = "post"  onsubmit = "return add_reel_size('reel_size'); " >
                            <select class="form-select" name="SelectFluteType" id="SelectFluteType" onchange="this.form.submit();" > 
                                <option value=""> </option>
                                <option value="All">All</option> 
                                <option value="Received Goods">Received Goods</option>
                                <option value="Stock Out RQT">Stock Out RQT</option> 
                            </select>
                            <input type="hidden" name="ListType" value = "Selected Jobs List" > 
                            <input type="hidden" name="reel_size" id = "reel_size_1" value="<?=(isset($_REQUEST['reel_size'])) ? $_REQUEST['reel_size'] : '' ?>" > 
                        </form>
                    </div> 
                <?php
                }
                elseif($ListType=='Available Stock')
                {
                    $Col='col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-4 pt-1 my-1';
                ?>
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                        <label class="fw-bold my-1" for="SelectFluteType">Select Product </label>
                        <form action="" method = "post"  >
                            <select class="form-select" name="SelectProduct" id="SelectProduct"  onchange="this.form.submit();"> 
                                <option value=""></option>
                                <option value="">Pofak</option> 
                            </select>
                            <input type="hidden" name="ListType" value = "Available Stock" > 
                        </form>
                    </div>
            ...
            {
                $Col='col-lg-12 col-md-12 col-sm-12 col-xs-12  my-1';
            }
           
        ?>
       
        <div class="<?php if(isset($_REQUEST['ListType'])){ $ListType=$_REQUEST['ListType']; if($ListType=='Finish Goods Check List' || $ListType=='Goods Request Check List'){ echo $COL; }else{ echo $Col; } }else{echo $Col;}?>"> 
            ...
            <thead>
                <tr class="table-info">
                    ...
                    <?php
                        ...
                        {
                            $ListType=$_REQUEST['ListType'];
                            if($ListType=='Finish Goods Check List')
                            {?>
                                <th>In Date</th>
                                <th>GRN</th>
                                <th>JobNo</th>
                            ...
                            elseif($ListType=='Goods Request Check List')
                            {?>
                                <th>Request Date</th>
                                <th>GRN</th>
                                <th>JobNo</th>
                            ...
                            elseif($ListType=='RG Resale List')
                            {?>
                                <th>Date</th>
                                <th>JobNo</th>
                            ...
                            {?>
                                ...
                                <th title="Available QTY">A.QTY</th>
                                <th>Design</th>
                                <th>Note </th>
                            <?php
                            }
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Postpond Comment</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form action="ProductionStateChanger.php" method = "post" >
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  "> 
                         <textarea name="PostpondComment" id="PostpondComment" cols="60" rows="10" class="form-control"></textarea>
                    </div><!-- END OF COL   -->
            ...
            <div class="modal-footer">
                ...
                <button  class="btn btn-primary"  type="submit" name="CommentFromModal" >Save</button>
            </div>
        </form>
    </div>
  </div>
