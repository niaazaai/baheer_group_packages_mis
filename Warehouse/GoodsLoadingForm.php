...
{
    $CTNId=$_REQUEST['CTNId']; $PROId=$_REQUEST['PROId']; $CustId=$_REQUEST['CustId'];
...
if(isset($_POST['Save&submit']))
{
    ...
    $Insert=$Controller->QueryData("INSERT INTO cartonstockout (PrStockId,CtnCustomerId,CtnJobNo,UserId1,TotalPlat,LineQTY,PacksInLine,ExtraPackes,TotalPackes,PerPackes,Pieces,TotalQTY) VALUES(?,?,?,?,?,?,?,?,?,?,?,?) ",
    [$PROId,$CustId,$CTNId,1, $TotalPlat,$LineQTY,$PackesInLine,$Extrapackes,$TotalPackes,$PerPackes,$Pieces,$TotalQTY]);  
    if($Insert)
    {
        header("Location:JobCenter.php?msg=Loading Data Saved...");   
    }
...
<div class="card m-3">
    <div class="card-body">
        <h3>
            ...
            Goods Loading Form - Warehouse Dep 
        </h3>
    </div>
</div>
