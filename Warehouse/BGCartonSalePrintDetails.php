...
if((isset($_GET['CartonId']) && !empty('CartonId') ) ) {

   $CTNId=$_GET['CartonId'];

  $Query = "SELECT `CtnoutId`, carton.CTNId ,carton.CTNType , CTNUnit  ,`CtnStockOutDate`, ppcustomer.CustName, carton.ProductName,carton.`CTNWidth`, 
  carton.`CTNHeight`, carton.`CTNLength`, carton.CTNQTY, `CtnOutQty`, `CtnDriverName`, `CtnCarNo`, 
  ...
  $DataRows = $Controller->QueryData($Query ,  [$CTNId] ); 
...
<div class="card-body  d-flex justify-content-between">
    <h3 class = "my-0">  
        <a class="btn btn-outline-primary  " href="BGCarton.php">
        ...
        <table class="table" id="sss">
            ...
            <tbody>
                ...
                while($Rows = $DataRows->fetch_assoc()) : ?>
                  <span style = "display:none;" id = "description"><?= $Rows['ProductName']  . ' ('  .  $Rows['CTNLength'] . ' X '.  $Rows['CTNWidth'] .' X ' . $Rows['CTNHeight']. ') -  ' . $Rows['CTNType']  . ', ' . $Rows['CTNUnit'];  ?></span>
                    ...
                    <tr>  
                        ...
                        <td class="text-center">
                              <a href="BGCartonSaleGatePass.php?CTNId=<?=$_GET['CartonId']?>&CtnoutId=<?=$Rows['CtnoutId']?>" class="btn btn-outline-primary btn-sm m-1 border-3 fw-bold" target="_blank">
                                  Print
                              </a>  
                        </td>
                    </tr>
