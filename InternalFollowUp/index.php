...
// job arrived at finance department , track when the job arrived there if arrival time + deadline is greater then current time. 
    ...
    CTNStatus , carton.followed_up , CTNQTY  
        FROM carton
...
<meta http-equiv="refresh" content="180" >
    ...
    <div class="m-3">
        <div class="card"   >
            ...
            <div>
                <a href="Internal_follow_up_setting.php" class = "btn btn-sm btn-primary" >
    ...
    <div class  = "m-3">
      <div class="card">
        <div class="card-body">
            <div class = "mb-2" >
                <a href = "#"  ><span class = "badge bg-info position-relative">Task List 
                    <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"> 5+  </span>
                </span></a>
                <a href = "../Marketing/FinishedGoods.php" onclick = "PutSearchTermToInputBox('Urgent')"><span class = "badge bg-danger  ">Finish Goods</span></a>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    $comment = ""; 
                                    $follow_up_counter= 0 ; 
                                    $fol = $Controller->QueryData( "SELECT comment FROM follow_up where CTNId = ? AND customer_id = ?", [$Data['CTNId'] , $Data['CustId']]); 
                                    if($fol->num_rows > 0 ) {
