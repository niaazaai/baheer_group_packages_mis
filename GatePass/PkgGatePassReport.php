...
<div class="card m-3 shadow">
    <div class="card-body d-flex justify-content-between  align-middle   ">
        ...
        <h3  class = "m-0 p-0  " > 
          <a class="btn btn-outline-primary " href="PkgGatePass.php">
        ...
        <form action="" method="POST"> 
            <div class="row " > 
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 ">
                    <label for="From" class="fw-bold pb-1">From</label>
              ...
              <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 my-4"> 
