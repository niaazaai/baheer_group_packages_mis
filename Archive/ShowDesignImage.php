...
elseif( filter_has_var(INPUT_GET,'Scatch') && filter_has_var(INPUT_GET, 'ProductName'))
{
    $Scatch=$_GET['Scatch'];  
    $ProductName = $_GET['ProductName']; 
 ...
 <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container">
    <a class="navbar-brand" href="#">
        ...
        <?php if(isset($_GET['Url'])){ echo 'Design Image for'; }elseif(isset($_GET['Scatch'])){ echo 'Scatch Image for';} ?>  <?=$ProductName ?>
    </a>
    ...
    <div class="card">
        <div class="card-body">
            <?php if(isset($_GET['Url']))
                  ...
                  elseif(isset($_GET['Scatch']))
                  {?>
                         <img src="../Assets/ArchiveSketch/<?=$Scatch;?>" class="img-fluid" alt="Scatch Image ">
                  <?php
                  }
                  ?>
        </div>
