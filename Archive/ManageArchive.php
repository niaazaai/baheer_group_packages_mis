...
?>
    ...
    <div class="card m-3 shadow">
        <div class="card-body d-flex justify-content-between  align-middle   ">
            ...
            <h3 class="m-0 p-0  "> 
                <a class="btn btn-outline-primary btn-sm P-1 "  href="ArchiveJobCenter.php?ListType=<?=$ListType?>">
                ...
                Jobs Processing Form  <span style="color:#FA8b09;">  </span>     
            </h3>
                            ...
                            {  
                                ...
                                {?>
                                    ...
                                    <?php  if(in_array( $Gate['VIEW_CREATE_POLYMER_BUTTON_JP'] , $_SESSION['ACCESS_LIST']  )) {?>
                                        <a class="btn btn-outline-primary btn-sm" href="CreatePolymer.php?CustId=<?=$CustId?>&CTNId=<?=$Rows['CTNId']?>&ListType=<?=$ListType?>">Create Polymer</a>
                                    <?php } ?>
                                <?php     
                                }
                                if($Rows['DieId']=='')
                                {?>
                                    <?php  if(in_array( $Gate['VIEW_CREATE_DIE_BUTTON_JP'] , $_SESSION['ACCESS_LIST']  )) {?>
                                        <a class="btn btn-outline-primary btn-sm" href="CreateDie.php?CustId=<?=$CustId?>&CTNId=<?=$Rows['CTNId']?>&ListType=<?=$ListType?>">Create Die</a>
                                    <?php } ?>
                                <?php
                                } 
                            } 
    ...
    <div class="card m-3 shadow">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 my-1">
                ...
                <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12 my-1">
