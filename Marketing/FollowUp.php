...
<div class="card  mb-3">
    <div class="card-body d-flex justify-content-between ">
        <h3> 
        <a class= "btn btn-outline-primary  " href="FinishedGoods.php">
...
<div class="card  m-3">
    <div class="card-body table-responsive ">
        <table class="table" id = "main-table"  >
            ...
            <?php
                $FollowUpDB  = $Controller->QueryData("SELECT * FROM follow_up WHERE customer_id  = ?  ", [$CustId] );
