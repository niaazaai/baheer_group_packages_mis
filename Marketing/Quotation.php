...
<div class="card m-3 shadow">
  ...
  <form class=" " enctype="multipart/form-data" id="feedback_form" method="post" action="<?=htmlspecialchars('QuotationController.php'); ?>">
      ...
      <div class="row my-3 gy-2 gx-3 align-items-center p-0" id = "JobTypeRow"  style = "display:none;">
        <div class="col-xxl-2  col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12  p-0 ">
        </div>
        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12 p-0">
            <!-- ZERO ROW  -->
            <label for="ProductName" class="form-label mt-0  "> Quotation Type </label>
            <select name="jobType"  class ="form-select "   >
              <option selected value="Normal">New Quote</option>
      ...
      <div class="row   align-items-center " >
        ...
        <label for="CustomerName" class="form-label">Last Job No <span class="text-danger"> * </span></label>
          <div class="custom-search" >
            ...
            <?php if(isset($_REQUEST['Page']) && !empty($_REQUEST['Page']) ) { if($_REQUEST['Page'] == 'CustomerOrderPage' ): ?>
