<?php 
    ...
    $Gate = require_once  $ROOT_DIR . '/Auth/Gates/ORDER_LIST';
    if(!in_array( $Gate['VIEW_ORDER_LIST'] , $_SESSION['ACCESS_LIST']  )) {
...
<div class="card m-3 shadow">
    <div class="card-body d-flex justify-content-between  align-middle   ">
        ...
        <div  class = "my-1"> <!--Button trigger modal div-->
            <?php  if(in_array( $Gate['VIEW_SETUP_BTN_ORDER_LIST'] , $_SESSION['ACCESS_LIST']  )) { ?> 
...
<div class="card m-3"> <!-- Start tag of card div -->
    ...
    <form action="" id="FORM" method="POST">
        ...
        <table class="table " id="OrderTable">
            ...
            <?php  if(in_array( $Gate['SHOW_VIEW_BTN_ORDER_LIST'] , $_SESSION['ACCESS_LIST']  )) { ?> 
