...
$Gate = require_once  $ROOT_DIR . '/Auth/Gates/PRODUCT_LIST';
  
if(!in_array( $Gate['VIEW_PRODUCT_LIST'] , $_SESSION['ACCESS_LIST']  )) {
...
<div class="card m-3 shadow">
    <div class="card-body d-flex justify-content-between  align-middle   ">
        ...
        <div  class = "my-1"> <!--Button trigger modal div-->
            ...
            <?php  if(in_array( $Gate['VIEW_SETUP_BTN_PRODUCT_LIST'] , $_SESSION['ACCESS_LIST']  )) { ?> 
