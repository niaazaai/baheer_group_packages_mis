...
$Gate = require_once  $ROOT_DIR . '/Auth/Gates/CANCEL_QUOTATION';
if(!in_array( $Gate['VIEW_CANCEL_QUOTATION'] , $_SESSION['ACCESS_LIST']  )) {
...
<div class="card m-3 shadow">
    <div class="card-body d-flex justify-content-between  align-middle   ">
        ...
        <?php  if(in_array( $Gate['VIEW_SETUP_BUTTON'] , $_SESSION['ACCESS_LIST']  )) { ?> 
