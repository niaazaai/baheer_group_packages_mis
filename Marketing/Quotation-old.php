    ...
    <div class="card-body    my-1   d-flex justify-content-between">
      ...
      <div>
        <h4>
          ...
          PKG Cost Estimation Form  <span class = "" style= "color:#FA8b09;" >  <?php  
       
          if(!isset($_GET['CostEstimation'])  )  { echo  "( ".  $Customer['CustName'] . " )"; }  ?> </span>   
        </h4>
      </div>
  ...
  <div class="modal-dialog modal-md" >
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="row mb-1">
          <div class="col-lg-6">
                <ul class="list-group shadow" id = "PaperWeightList" >  </ul>
          </div>

          <div class="col-lg-6">
              <ul class="list-group  shadow" id = "PaperWeightollectedList" >  
                  <li class="list-group-item d-flex justify-content-between align-items-center" id = "BB_name"  style = "display:none !important;"   > 
                    <span style = " padding:0px;" > BB </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "BB_value" > 0 </strong></span> 
                  </li> 

                  <li class="list-group-item d-flex justify-content-between align-items-center" id = "WTL_name" style = "display:none  !important;"     > 
                    <span style = " padding:0px;" id = " " > WTL </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "WTL_value" > 0 </strong></span> 
                  </li> 

                  <li class="list-group-item d-flex justify-content-between align-items-center" id = "WTKL_name"  style = "display:none !important;"   > 
                    <span style = " padding:0px;" id = " " > WTKL </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "WTKL_value" > 0 </strong></span> 
                  </li> 

                  <li class="list-group-item d-flex justify-content-between align-items-center"  id = "TL_name"  style = "display:none !important;"  > 
                    <span style = " padding:0px;" id = " " > TL </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "TL_value" > 0 </strong></span> 
                  </li> 

                  <li class="list-group-item d-flex justify-content-between align-items-center" id = "KLB_name"  style = "display:none !important;"  > 
                    <span style = " padding:0px;" id = " " > KLB </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "KLB_value" > 0 </strong></span> 
                  </li> 

                  <li  style = "display:none !important;" class="list-group-item d-flex justify-content-between align-items-center" id = "Liner_name"  > 
                    <span style = " padding:0px;" id = " " > Liner </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "Liner_value" > 0 </strong></span> 
                  </li> 

                  <li class="list-group-item d-flex justify-content-between align-items-center"  id = "Flute_name" style = "display:none !important;"    > 
                    <span style = " padding:0px;" id = " " > Flute </span>  
                    <span class = "shadow" style = "border:2px solid black; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px; "  ><strong id = "Flute_value" > 0 </strong></span> 
                  </li> 

                  <li class="list-group-item d-flex justify-content-between align-items-center "  > 
                    <span style = "font-weight:bold; padding:0px;">TOTAL</span> 
                    <span class = "shadow" style = "border:2px solid #6610f2; padding:4px; padding-left:6px; padding-right:6px;  border-radius:4.5px;  "  >  
                    <strong id  = "paper_weight_total" >  </strong></span> 
                  </li> 
              </ul>
               <div class="input-group my-2">
                    ...
                    <input type="text" class = "form-control "     style = "max-width:120px" style = "border-right:none;" id = "DieckleInput" readonly >
              </div>
          </div>
        </div><!-- END OF ROW  -->
  ...
  <form class=" " enctype="multipart/form-data" id="feedback_form" method="post" action="<?=htmlspecialchars('QuotationController.php'); ?>">
      ...
      <div class="row   align-items-center " >
        ...
        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12" >
          ...
          <input class="form-control" id="CartonQTY" placeholder="Quantity" name="CartonQTY" type="text" required  onkeyup = "AddComma(this.value , this.id)"  onchange = "AddInputValues(this.name , this.value);"  />
        </div>

        <div  class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12" >
          <label for="PaperLength" class="form-label" > L <span class="text-danger"> * </span></label>
           <input class="form-control" id="PaperLength" placeholder="Lenght cm" name="PaperLength" type="text" onchange = "AddInputValues(this.name , this.value) "  required  />
        </div>
        ...
        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12"  id = "PaperWidthCol">
          ...
          <input class="form-control" id="PaperWidth" placeholder="Width cm" name="PaperWidth" type="text" onchange = "AddInputValues(this.name , this.value) "    />
        </div>

        <div  class="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-12 col-xs-12" >
          <label for="PaperHeight" class="form-label"> H <span class="text-danger"> * </span></label>
          <input class="form-control"   id="PaperHeight"  placeholder="Height cm" name="PaperHeight"  onchange = "AddInputValues(this.name , this.value) "  type="text" required  />
        </div>
      </div>
      <!-- SECOND  ROW  -->
      <hr>
      ...
      <div class="row   d-flex align-items-center  "  >
        ...
        <div class="row my-3   "  >
          ...
          <div class="col-xxl-1 col-xl-1 col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <?php if(!isset($_GET['CostEstimation'])  ) { ?>
              ...
              <?php } else { ?>
                <label for="d" class="form-label"> </label>
                <div>  <a href= "CustomerList.php" style = "border:none;" class="btn btn-danger fw-bold  mt-2 " style = "max-width:180px;"  >Close</a> </div>
            <?php  }?>
 ...
 <script>
  ...
  function CalculateUnitPrice(InputValues , NoFlip = false){
    ...
    for (const property in Paper) {    
       ...
       // this line of code is usde to copy paper gsm for paper weight calculation 
  ...
  function ChangeGrade( UserUnitPrice){
    let element = document.getElementById('CtnCurrency1');
     let SelectedCurrency = element.options[element.selectedIndex].value ; 
     if(SelectedCurrency == 'USD') {
      alert('Please Make sure you have selected the AFN Currency'); 
    ...
    document.getElementById('PaperGrade').value = Precision (Grade1) ; 
    AddInputValues('PaperGrade' , Precision (Grade1))
  } // CHANGE GRADE 
...
// console.log(Precision (35.587765694249995));

  // console.log( Precision (37.59)  * 500000);
  ...
  function CalculatePaperWeight(L , W , H , PaperWeight , CTNQTY ){
    ...
    for (const property in PaperWeight) {  
      ...
      if(Flute.test(property)) {
        Flute1 += Number(RequiredPaperKG); 
        document.getElementById('Flute_value').innerText = Precision(Flute1 / 1000  )  + " TON"; 
        document.getElementById('Flute_name').style.display = ''; 
      }
      else if(BB.test(property)) {
        BB1 += Number(RequiredPaperKG); 
        document.getElementById('BB_value').innerHTML = Precision(BB1 / 1000  )   + " TON"; 
        document.getElementById('BB_name').style.display = ''; 
      }
      else if(WTKL.test(property)) {
        WTKL1  += Number(RequiredPaperKG); 
        document.getElementById('WTKL_value').innerHTML = Precision(WTKL1 / 1000  )  + " TON"; 
        document.getElementById('WTKL_name').style.display = ''; 
      }
      else if(TL.test(property)) {
        TL1 += Number(RequiredPaperKG); 
        document.getElementById('TL_value').innerHTML = Precision(TL1 / 1000  )   + " TON"; 
        document.getElementById('TL_name').style.display = ''; 
      }
      else if(WTL.test(property)) {
        WTL1 += Number(RequiredPaperKG); 
        document.getElementById('WTL_value').innerHTML = Precision(WTL1 / 1000  )    + " TON";
        document.getElementById('WTL_name').style.display = '';  
      }
      else if(KLB.test(property)) {
        KLB1 += Number(RequiredPaperKG); 
        document.getElementById('KLB_value').innerHTML = Precision(KLB1 / 1000  )   + " TON"; 
        document.getElementById('KLB_name').style.display = ''; 
      }
      else if(Liner.test(property)) {
        Liner1 += Number(RequiredPaperKG); 
        document.getElementById('Liner_value').innerHTML =Precision(Liner1 / 1000  )    + " TON"; 
        document.getElementById('Liner_name').style.display = ''; 
      }
    ...
    document.getElementById('paper_weight_total').innerText = PaperTotalWeightTon + ' TON';
...
//     "WTKL_5": 125
// }
// CalculatePaperWeight(340 , 180 , 190 , asdf , 74000 );
